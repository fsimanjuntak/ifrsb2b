...
object SDPAdjTransformRepcs  {
    ...
    def main(args: Array[String]) {
        ...
        println("Print Start Processing SDP Adjustment Reprocess");  
        ...
        val SOURCE1 = Common.getConfigDirectory(sc, CONF_DIR, "SDP.SDP_ADJ_TRANSFORM.SOURCE_REJ_REF1_DIR");
        val existDir1= Common.isDirectoryExists(sc, SOURCE1)
        val SOURCE2 = Common.getConfigDirectory(sc, CONF_DIR, "SDP.SDP_ADJ_TRANSFORM.SOURCE_REJ_REF2_DIR");
        ...
        val OUTPUT_REJ_REF1_PERM = Common.getConfigDirectory(sc, CONF_DIR, "SDP.SDP_ADJ_TRANSFORM.OUTPUT_SDP_REJ_REF1_PERM_DIR").concat(CHILD_DIR);
        val OUTPUT_REJ_REF2_PERM = Common.getConfigDirectory(sc, CONF_DIR, "SDP.SDP_ADJ_TRANSFORM.OUTPUT_SDP_REJ_REF2_PERM_DIR").concat(CHILD_DIR);
