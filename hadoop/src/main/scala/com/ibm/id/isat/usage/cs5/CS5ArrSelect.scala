...
//          listTransformedRow.append(this.genCS5TransformedRow(lineMap, prcDt, jobId))
   ...
   */
  def genCS5PostTransformedRow( lineMap:Array[Array[String]], prcDt:String, jobId:String ) : Row = {  
...
//        this.getIntcctLkpPad( this.getPostOtherPartyNum(line) ) ,
   ...
   * @return CCN node
   */
  def getCCNNode( lineMap: Array[Array[String]] ) : String = {  
    return Common.safeGet( lineMap(0),3 )
  }
   ...
   */
  def getAPartyNumber( lineMap: Array[Array[String]] ) : String = {
    
    var msisdn = ""            
    if ( this.getNetworkDirection(lineMap) == "MO" ) {
      // Get SERVED_MSISDN
      msisdn = Common.getKeyVal( Common.safeGet( lineMap(0),10 ) , "0", "#", "[" )
    } else {
      // Get CCR_CHARGING_CONTEXT_SPECIFICS with param 16778219
      msisdn = Common.getKeyVal( Common.safeGet( lineMap(1),9 ), "16778219", "*", "]" )
    }       
   ...
   */
  def getBPartyNumber( lineMap: Array[Array[String]] ) : String = {
   ...
   * @returns "MO" or "MT"
   */
  def getNetworkDirection( lineMap: Array[Array[String]] ) : String = {
    val ccrServiceScenario = Common.safeGet( lineMap(1),4 )
   ...
   */
  def getServiceUsageType( lineMap: Array[Array[String]] ) : String = {
    val chargingContextId = Common.safeGet( lineMap(0),5 )
    val ccrServiceIdentifier = Common.safeGet( lineMap(1),0 )
    val ccrServiceScenario = Common.safeGet( lineMap(1),4 ) 
   ...
   */
  def getServiceUsageTypePostpaid( lineMap: Array[Array[String]] ) : String = {
   ...
   */
  def getMSCAddress( lineMap: Array[Array[String]] ) : String = {
    if ( getServiceUsageType(lineMap) == "VOICE" ) {
      //return Common.getTuple(content, "|", 12)
      return Common.safeGet( lineMap(0),12 )
    }
    else return ""
  }
   ...
   */
  def getOriginRealm( lineMap: Array[Array[String]] ) : String = {
    if ( getServiceUsageType(lineMap) == "SMS" ) {
      //return Common.getTupleInTuple(content, "|", 12, "#", 0)
      return Common.safeGet( lineMap(3),0 )
    }
    else return ""
  }
   ...
   */
   def getOriginHost( lineMap: Array[Array[String]] ) : String = {
    if ( getServiceUsageType(lineMap) == "SMS" ) {
      //return Common.getTupleInTuple(content, "|", 12, "#", 1)
      return Common.safeGet( lineMap(3),1 )
    }
    else return ""
  }
    ...
    */
  def getTransactionDate( lineMap: Array[Array[String]] ) : String = {
    return Common.safeGet( lineMap(1),3 ).take(8)
  }
  
  /**
    * Get transaction hour from CCR_TRIGGER_TIME
    */
  def getTransactionHour( lineMap: Array[Array[String]] ) : String = {
     return Common.safeGet( lineMap(1),3 ).substring(8, 10)
  }
  
  /**
    * Get service class
    */
  def getServiceClass( lineMap: Array[Array[String]] ) : String = {
     return Common.safeGet( lineMap(5),1 )
  }
  ...
  */
   ...
   * 
   */
  def getChargingContextSpecific( lineMap: Array[Array[String]], param:String ) : String = {
     //return Common.getKeyVal( Common.getTuple( Common.getTupleInTuple(content, "|", 13, "[", 0), "#", 9 ), param, "*", "]" )
    return Common.getKeyVal( Common.safeGet( lineMap(1),9 ), param, "*", "]" ) 
  }
   ...
   */
  def getMCCMNC( content: Array[Array[String]] ) : String = {
   ...
   * @return RAT Type 
   */
  def getRATType( lineMap: Array[Array[String]] ) : String = {
   ...
   * @return 
   */
  def getLAC( content: Array[Array[String]] ) : String = {
   ...
   * @return
   */
  def getCI( content: Array[Array[String]] ) : String = {
   ...
   * @return
   */
  def getECI( content: Array[Array[String]] ) : String = {
   ...
   * 
   */
  def getIMSI( lineMap: Array[Array[String]] ) : String = {
     //return Common.getKeyVal( Common.getTuple(content, "|", 10) , "1", "#", "[" )
    return Common.getKeyVal( Common.safeGet( lineMap(0),10 ) , "1", "#", "[" )
  }
  
  /*
   * 
   */
  def getAPN( lineMap: Array[Array[String]] ) : String = {
   ...
   * 
   */
  def getServiceScenario( lineMap: Array[Array[String]] ) : String = {
     //return Common.getTuple( Common.getTupleInTuple(content, "|", 13, "[", 0), "#", 4 )
     return Common.safeGet( lineMap(1),4 )
  }
  
  /*
   * 
   */
  def getRoamingPosition( lineMap: Array[Array[String]] ) : String = {
     //return Common.getTuple( Common.getTupleInTuple(content, "|", 13, "[", 0), "#", 6 )
    return Common.safeGet( lineMap(1),6 )
  }
  
  /*
   * 
   */
  def getFAF( lineMap: Array[Array[String]] ) : String = {
     //return Common.getTupleInTuple( Common.getTupleInTuple(content, "|", 13, "[", 0), "#", 8 , "*", 8)
    return Common.safeGet( lineMap(5),8 )
  }
  
  /*
   * 
   */
  def getFAFNumber( lineMap: Array[Array[String]] ) : String = {
     //return Common.getTupleInTuple( Common.getTupleInTuple(content, "|", 13, "[", 0), "#", 8 , "*", 9)
     return Common.safeGet( lineMap(5),9 )
  }
  
  /*
   * Need further checking to other service type
   */
  def getRatingGroup( lineMap: Array[Array[String]] ) : String = {
    //return Common.getTupleInTuple(content, "|", 6, ":", 0)
    return Common.safeGet( lineMap(2),0 )
  }
  
  /*
   * Need further checking to other service type
   */
  def getContentType( lineMap: Array[Array[String]] ) : String = {
     //return Common.getTupleInTuple(content, "|", 6, ":", 1) 
     return Common.safeGet( lineMap(2),1 )
  }
  
  /*
   * 
   */
  def getIMEI( lineMap: Array[Array[String]] ) : String = {
   ...
   * 
   */
  def getGGSNAddress( lineMap: Array[Array[String]] ) : String = {
   ...
   * 
   */
  def getSGSNAddress( lineMap: Array[Array[String]] ) : String = {
   ...
   * 
   */
  def getCallReference( lineMap: Array[Array[String]] ) : String = {
     return getChargingContextSpecific(lineMap, "16778229")
  }
   ...
   * 
   */
  def getCorrelationId( lineMap: Array[Array[String]] ) : String = {
     // return Common.getTuple(content, "|", 11)
     return Common.safeGet( lineMap(0),11 )
  }
  
  /*
   * 
   */
  def getChargingId( lineMap: Array[Array[String]] ) : String = {
   ...
   * 
   */
  def getServiceOfferId( lineMap: Array[Array[String]] ) : String = {
     //return Common.getTupleInTuple( Common.getTupleInTuple(content, "|", 13, "[", 0), "#", 8 , "*", 10)
     return Common.safeGet( lineMap(5),10 )
  }
  
  /*
   * 
   */
  def getPaymentCategory( lineMap: Array[Array[String]]  ) : String = {
  ...
  /**
 	...
 	*/
  def getDedicatedAccountsRow( lineMap: Array[Array[String]] ) : String = {
    //return Common.getTupleInTuple( Common.getTupleInTuple(content, "|", 13, "[", 0), "#", 8, "*", 7 )
    return Common.safeGet( lineMap(5),7 )
  }
  ...
  /**
 	...
 	*/
  def getDedicatedAccountValuesRow( lineMap: Array[Array[String]] ) : String = {
  ...
  /**
 	...
 	* @returns DA_ID,DA_AMOUNT,DA_UNIT_AMOUNT,DA_UNIT_TYPE(UOM) separated by ~. Multiple DA by ^
 	*/
  def getDedicatedAccountValuesRowPostpaid( lineMap: Array[Array[String]] ) : String = {
    val daRow = this.getDedicatedAccountsRow(lineMap)
   ...
   * Get account group
   */
  def getAccountGroup( lineMap: Array[Array[String]] ) : String = {
     //return Common.getTupleInTuple( Common.getTupleInTuple(content, "|", 13, "[", 0), "#", 8, "*", 2 )
     return Common.safeGet( lineMap(5),2 )
  }
  
   /**
   * Get traffic case
   */
  def getTrafficCase( content: Array[Array[String]]) : String = {
   ...
   * Get FAF name
   */
  def getFAFName( lineMap: Array[Array[String]] ) : String = {
   ...
   * Get usage volume
   */
  def getUsageVolume( lineMap: Array[Array[String]] ) : Double = {
    //val volume = Common.toDouble( Common.getTupleInTuple( Common.getTupleInTuple(content, "|", 13, "[", 0), "#", 1, "*", 3 ) )
    val volume = Common.toDouble( Common.safeGet( lineMap(4),3 ) )
    return volume
  }
   ...
   * Get usage duration
   */
  def getUsageDuration( lineMap: Array[Array[String]] ) : Double = {
     //val duration = Common.toDouble( Common.getTupleInTuple( Common.getTupleInTuple(content, "|", 13, "[", 0), "#", 1, "*", 1 ) )
     val duration = Common.toDouble( Common.safeGet( lineMap(4),1 ) )
     return duration
  }
   ...
   * Get filename
   */
  def getFileName( lineMap: Array[Array[String]] ) : String = {
     //return this.getFilenameFromPath( Common.getTuple(content, "|", 15) )
     return this.getFilenameFromPath( Common.safeGet( lineMap(0),15 ) )
  }
  
  /**
   * Get account value deducted
   */
  def getAccountValueDeducted( lineMap: Array[Array[String]] ) : String = {
     //return Common.getTuple( Common.getTupleInTuple( Common.getTupleInTuple(content, "|", 13, "[", 0), "#", 8, "*", 13 ) , "~" , 0)
     return Common.getTuple( Common.safeGet( lineMap(5),13 ) , "~" , 0)
  }
  
  /**
   * Get accumulator
   */
  def getAccumulator( lineMap: Array[Array[String]] ) : String = {
     //return Common.getTupleInTuple( Common.getTupleInTuple(content, "|", 13, "[", 0), "#", 8, "*", 6 )
     return Common.safeGet( lineMap(5),6 )
  }
   ...
   */
  def getCommunityId( lineMap: Array[Array[String]], item:Integer ) : String = {
     //val servedCommunityIDs = Common.getTuple( Common.getTupleInTuple( Common.getTupleInTuple(content, "|", 13, "[", 0), "#", 8, "*", 5 ) , "~", 1)
    val servedCommunityIDs = Common.getTuple( Common.safeGet( lineMap(5),5 ) , "~", 1)    
     try {
   ...
   */
  def getAccumulatedCost( lineMap: Array[Array[String]] ) : Double = {
    //val accumulatedCost = Common.getTuple( Common.getTupleInTuple( Common.getTupleInTuple(content, "|", 13, "[", 0), "#", 8, "*", 11 ) , "~", 0)
    val accumulatedCost = Common.getTuple( Common.safeGet( lineMap(5),11 ) , "~", 0)
   ...
   * Get hits
   */
  def getHit( lineMap: Array[Array[String]] ) : Integer = {
     return  1
  }
   ...
   */
  def getCallClassCat( lineMap: Array[Array[String]] ) : String = {
     //return  Common.getKeyVal( Common.getTuple( Common.getTupleInTuple(content, "|", 13, "[", 0), "#", 10 ) , "DWSCallClassCategory", "*", "]" )
     return  Common.getKeyVal( lineMap(1)(10 ) , "DWSCallClassCategory", "*", "]" )
  }
  
  /**
   * Get tariff category
   */
  def getTariffCat( lineMap: Array[Array[String]] ) : String = {
     //return  Common.getKeyVal( Common.getTuple( Common.getTupleInTuple(content, "|", 13, "[", 0), "#", 10 ) , "DWSCallClassCategory", "*", "]" )
     return  Common.getKeyVal( lineMap(1)(10 ) , "DWSTariffCategory", "*", "]" )
  }
   ...
   */
  def getIntcctType ( lineMap: Array[Array[String]] ) : String = {
   ...
   */
  def getVasServiceId ( lineMap: Array[Array[String]] ) : String = {
   ...
   */
  def getUsedOfferSC ( lineMap: Array[Array[String]] ) : String = {
    //val offers = Common.getTupleInTuple( Common.getTupleInTuple(content, "|", 13, "[", 0), "#", 8, "*", 20 ) 
    val offers = Common.safeGet( lineMap(5),20 )
   ...
   */
  def getOfferAttributeAreaname ( lineMap: Array[Array[String]] ) : String = {
    //return Common.getKeyVal( Common.getTuple( Common.getTupleInTuple(content, "|", 13, "[", 0), "#", 10 ) , "AREANAME", "*", "]" )  
    return Common.getKeyVal( Common.safeGet( lineMap(1),10 ) , "AREANAME", "*", "]" )
  }
   ...
   */
  def getAccountValueBefore( lineMap: Array[Array[String]] ) : String = {    
    //return Common.getTuple( Common.getTupleInTuple( Common.getTupleInTuple(content, "|", 13, "[", 0), "#", 8, "*", 3 ) , "~" , 0)
    return Common.getTuple( Common.safeGet( lineMap(5),3 ) , "~" , 0)
  }
   ...
   */
  def getAccountValueAfter( lineMap: Array[Array[String]] ) : String = {    
    //return Common.getTuple( Common.getTupleInTuple( Common.getTupleInTuple(content, "|", 13, "[", 0), "#", 8, "*", 4 ) , "~" , 0)
    return Common.getTuple( Common.safeGet( lineMap(5),4 ) , "~" , 0)
  }
  
  /**
   * CCR_TRIGGER_TIME
   */
  def getCCRTriggerTime( lineMap: Array[Array[String]] ) : String = {    
    //return Common.getTuple( Common.getTupleInTuple(content, "|", 13, "[", 0), "#", 3 ).substring(0, 14)
    return Common.safeGet( lineMap(1), 3 ).substring(0, 14)
  } 
   ...
   * CCR_EVENT_TIME
   */
  def getCCREventTime( lineMap: Array[Array[String]] ) : String = {    
    //return Common.getTuple( Common.getTupleInTuple(content, "|", 13, "[", 0), "#", 2 ).substring(0, 14)
    return Common.safeGet( lineMap(1), 2 ).substring(0, 14)
  } 
  
  /**
   * CCR_CCA_SPECIFIED_CONSUMPTION
   */
  def getCcrCcaSpecConsump( lineMap: Array[Array[String]] ) : String = {    
    //return Common.getTupleInTuple( Common.getTupleInTuple(content, "|", 13, "[", 0), "#", 8 ,"*", 19)
    return Common.safeGet( lineMap(5),19 )
  } 
  
  /**
   * CCR_CCA_SPECIFIED_CONSUMPTION SP MADA
   */
  def getSpecConsumpSPMADA( lineMap: Array[Array[String]] ) : String = {
    try {
   ...
   */
  def getSpecConsumpSPCONS( lineMap: Array[Array[String]] ) : String = {
    try {
   ...
   * Get MSISDN  
   */
  def getMSISDN( lineMap: Array[Array[String]] ) : String = {  
    return Common.getKeyVal( lineMap(0)(10) , "0", "#", "[" )
  }
   ...
   */
  def getRecordId( lineMap: Array[Array[String]] ) : String = {  
   ...
   */
  def getFileDate( lineMap: Array[Array[String]] ) : String = {  
    //return this.getFilenameFromPath( Common.getTuple(content, "|", 16) )
    return Common.safeGet( lineMap(0),16 )
  }
   ...
   */
  def getServiceIdentifier( lineMap: Array[Array[String]] ) : String = {
    //return Common.getTuple( Common.getTupleInTuple(content, "|", 13, "[", 0), "#", 0 )  
    return Common.safeGet( lineMap(1),0 )
  }
   ...
   */
  def getCCRTreeDefinedFields( lineMap: Array[Array[String]] ) : String = {
     //return  Common.getTuple( Common.getTupleInTuple(content, "|", 13, "[", 0), "#", 10 )
    return  return Common.safeGet( lineMap(1),10 )
  }
  
  /**
   * Get CCR bonus adjustment
   */
  def getCCRBonusAdjustment( lineMap: Array[Array[String]] ) : String = {
     //return  Common.getTuple( Common.getTupleInTuple(content, "|", 13, "[", 0), "#", 11 )
     return Common.safeGet( lineMap(1),11 )
  }
  
  /**
   * Get charging context ID
   */
  def getChargingContextId( lineMap: Array[Array[String]] ) : String = {
    return Common.safeGet( lineMap(0),5 )
  }
   ...
   */
  def getPostEventId( lineMap: Array[Array[String]] ) : String = {
     val chargingContextId=this.getChargingContextId(lineMap)
   ...
   */
  def getPostOtherPartyNum( lineMap: Array[Array[String]] ) : String = {
     //return  Common.getKeyVal( Common.getTuple( Common.getTupleInTuple(content, "|", 13, "[", 0), "#", 9 ), "16778219", "*", "]" )
    return  Common.getKeyVal( Common.safeGet( lineMap(1),9 ), "16778219", "*", "]" )
  }
   ...
   */
  def getPostVasServiceId ( lineMap: Array[Array[String]] ) : String = {
   ...
   */
  def getPostCCRTriggerTime( lineMap: Array[Array[String]] ) : String = {    
    //return Common.getTuple( Common.getTupleInTuple(content, "|", 13, "[", 0), "#", 3 )
    return Common.safeGet( lineMap(1),3 )
  } 
  
  /**
   * CCR_EVENT_TIME for postpaid
   */
  def getPostCCREventTime( lineMap: Array[Array[String]] ) : String = {    
    //return Common.getTuple( Common.getTupleInTuple(content, "|", 13, "[", 0), "#", 2 )
    return Common.safeGet( lineMap(1),2 )
  } 
   ...
   */
  def getMapOfLine( line:String , paymentType:String) : Array[Array[String]] = {
