...
object SDPLcyTransformLocal {
    ...
    def main(args: Array[String]) {
        ...
        val sdpLcySrcRDD = sc.textFile(INPUT_DIR);
        ...
        //val sdpLcySrcRDD = sc.textFile("/user/apps/nonusage/sdp/lcy/*.LCY");
        
        
       
        val OUTPUT_REJ_BP_DIR = Common.getConfigDirectory(sc, CONF_DIR, "SDP.SDP_LCY_TRANSFORM_LOCAL.OUTPUT_SDP_REJ_BP_DIR").concat(CHILD_DIR)
        ...
        val OUTPUT_CDR_INQ_DIR = Common.getConfigDirectory(sc, CONF_DIR, "SDP.SDP_LCY_TRANSFORM_LOCAL.OUTPUT_SDP_CDR_INQ_DIR").concat(CHILD_DIR)
