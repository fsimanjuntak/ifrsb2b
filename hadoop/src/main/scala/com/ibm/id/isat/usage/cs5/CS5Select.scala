  ...
  def genCS5TransformedRowList( line:String , paymentType:String, prcDt:String, jobId:String ) : List[Row] = {
    ...
    while ( i<level2_ccr_multiple.length ) {
        ...
        val variablesArr = Array (
              this.getServiceUsageType(lineMap),   //0: Service Usage Type
              this.getNetworkDirection(lineMap)    //1: Network direction (MO/MT)
                                                   //etc...
            )
        
        //Add frequently used variables to Map
        val lineMapNew = lineMap + ("variablesArr" -> variablesArr)
      
        //Add map to list
      if ( paymentType=="POSTPAID" )
        listTransformedRow.append(this.genCS5PostTransformedRow(lineMapNew, prcDt, jobId))
       else if ( this.cs5RecordsIsNotGarbage(lineMap) ) {
       //else if ( this.cs5RecordsIsNotGarbageOrHasVolume(lineMap) ) {
       //else {
            //PREPAID
            listTransformedRow.append(this.genCS5TransformedRow(lineMapNew, prcDt, jobId))
        }
   ...
   */
   def genCS5TransformedRow( lineMap:Map[String, Array[String]], prcDt:String, jobId:String) : Row = {  
    ...
    return Row(this.getTransactionDate(lineMap)
          ...
          ,this.getSpecConsumpSPOfferId(lineMap)
          ,this.getCcrCcaSpecConsump(lineMap)
          ...
          ,this.getNormalizedCCRTriggerTime(lineMap)
          ,this.getSSPTransactionId(lineMap)
          ,this.getCCSSubsLocation(lineMap)
          ,this.getCGI(lineMap) //reserved field 1
          ,"" //reserved field 2
          ,"" //reserved field 3
          ,"" //reserved field 4
          ,"" //reserved field 5
...
//        this.getIntcctLkpPad( this.getPostOtherPartyNum(line) ) ,
        ...
        this.getFileDate(lineMap),
        this.getCCSSubsLocation(lineMap),
        this.getSSPTransactionId(lineMap), //reserved field 1
        this.getAPartyNumber(lineMap), //reserved field 2
        this.getNormalizedCCRTriggerTime(lineMap) //reserved field 3
        ,"" //reserved field 4
        ,"" //reserved field 5
        ,"" //reserved field 6
        ,"" //reserved field 7
   ...
   */
   def genCS5RejectedRow( line:String, prcDt:String, jobId:String ) : Row = {  
      ...
      * Original+multicluster+transposeId: 117
      * Original+multicluster+transposeId+normalizedCCRTrigTime+SSPTransId: 119
      * 119+SubsLocation+RsvFld1-10: 130
      */
     ...
     return {
      if ( len==130 )
        Row(
           ...
           r(21), r(22), r(23), r(24), r(25), r(26).stripPrefix("\"").stripSuffix("\""), r(27), r(28), r(29), r(30), r(31), genDedicatedAccountValuesRowReject(r(108), r(109), r(105), r(106), r(107)), r(33), r(34), genAccountValueDeducted( r(109), r(105), r(35) ) , r(36), r(37), r(38), r(39), Common.toDouble(r(40)),
           ...
           r(61), r(62), r(63), r(64), r(65), r(66), r(67), r(68), r(69), r(70), r(71), r(72), r(73), r(74), r(75), r(76)          
         )
      else if ( len==119 )
         Row(
           r(0), r(1), r(2), r(3), r(4),  r(5), r(6),  r(7), r(8), r(9), r(10), r(11), r(12), r(13), r(14), r(15), r(16), r(17),  r(18), r(19), r(20),
           r(21), r(22), r(23), r(24), r(25), r(26).stripPrefix("\"").stripSuffix("\""), r(27), r(28), r(29), r(30), r(31), genDedicatedAccountValuesRowReject(r(97), r(98), r(94), r(95), r(96)), r(33), r(34), r(35), r(36), r(37), r(38), r(39), Common.toDouble(r(40)),
           Common.toInt(r(41)), Common.toDouble(r(42)), Common.toDouble(r(43)), r(44), r(45), r(46), r(47), r(48),r(49), r(50), r(51), r(52), r(53), r(54), r(55), r(56), jobId, r(58), prcDt, r(60), 
         ...
         Row(
           r(0), r(1), r(2), r(3), r(4),  r(5), r(6),  r(7), r(8), r(9), r(10), r(11), r(12), r(13), r(14), r(15), r(16), r(17),  r(18), r(19), r(20),
           r(21), r(22), r(23), r(24), r(25), r(26).stripPrefix("\"").stripSuffix("\""), r(27), r(28), r(29), r(30), r(31), r(95)+"~"+r(96)+"~"+r(92)+"~"+r(93)+"~"+r(94), r(33), r(34), r(35), r(36), r(37), r(38), r(39), Common.toDouble(r(40)),
           Common.toInt(r(41)), Common.toDouble(r(42)), Common.toDouble(r(43)), r(44), r(45), r(46), r(47), r(48),r(49), r(50), r(51), r(52), r(53), r(54), r(55), r(56), jobId, r(58), prcDt, r(60), 
           r(61), r(62), r(63), "", "", "", "", "", "", "", "", "", "", "", "", ""          
         )
          ...
          Row(
           r(0), r(1), r(2), r(3), r(4),  r(5), r(6),  r(7), r(8), r(9), r(10), r(11), r(12), r(13), r(14), r(15), r(16), r(17),  r(18), r(19), r(20),
           r(21), r(22), r(23), r(24), r(25), r(26).stripPrefix("\"").stripSuffix("\""), r(27), r(28), r(29), r(30), r(31), "1~"+r(95)+"~"+r(92)+"~"+r(93)+"~"+r(94), r(33), r(34), r(35), r(36), r(37), r(38), r(39), Common.toDouble(r(40)),
           Common.toInt(r(41)), Common.toDouble(r(42)), Common.toDouble(r(43)), r(44), r(45), r(46), r(47), r(48),r(49), r(50), r(51), r(52), r(53), r(54), r(55), r(56), jobId, r(58), prcDt, r(60), 
           r(61), r(62), r(63), "", "", "", "", "", "", "", "", "", "", "", "", ""          
         )
           ...
           Row(
             r(0), r(1), r(2), r(3), r(4),  r(5), r(6),  r(7), r(8), r(9), r(10), r(11), r(12), r(13), r(14), r(15), r(16), r(17),  r(18), r(19), r(20),
             r(21), r(22), r(23), r(24), r(25), r(26).stripPrefix("\"").stripSuffix("\""), r(27), r(28), r(29), r(30), r(31), "1~"+r(93)+"~"+r(90)+"~"+r(91)+"~"+r(92), r(33), r(34), r(35), r(36), r(37), r(38), r(39), Common.toDouble(r(40)),
             Common.toInt(r(41)), Common.toDouble(r(42)), Common.toDouble(r(43)), r(44), r(45), r(46), r(47), r(48),r(49), r(50), r(51), r(52), r(53), r(54), r(55), r(56), jobId, r(58), prcDt, r(60), 
             r(61), r(62), "", "", "", "", "", "", "", "", "", "", "", "", "", ""          
         )
     }     
   ...
   /**
    * Generate DA deducted value for reprocess: If MA then empty
    * @return 
    */
   def genDedicatedAccountValuesRowReject( transposeId:String, accountId:String, amount:String, unitAmount:String, unitType:String ) : String = {
     if (accountId=="MA") return ""
     else 
       return transposeId+"~"+accountId+"~"+amount+"~"+unitAmount+"~"+unitType
   }    
   
    /**
    * Generate account value deducted value for reprocess: If MA then use AMOUNT
    * @return 
    */
   def genAccountValueDeducted( accountId:String, amount:String, accountValueDeducted:String ) : String = {
     if (accountId=="MA") return amount
     else return accountValueDeducted
   }
   ...
   */
   def genCS5RejectedRowPostpaid( line:String, prcDt:String, jobId:String ) : Row = {  
      ...
      * Number of reject column:
      * Original: 101
      * Original+SubsLocation+RsvFld1-10: 112
      */
     ...
     return {
       if (len==112) 
         ...
         r(61), r(62), jobId, r(64), prcDt, r(66), r(67), r(68), r(69), r(70), r(71), r(72), r(73), r(74), r(75), r(76), r(77), r(78)                
         )
       else 
         Row(
         r(0), r(1), r(2), r(3), r(4),  r(5), r(6),  r(7), r(8), r(9), Common.toDouble(r(10)), r(11), r(12), r(13), r(14), r(15), r(16), r(17),  r(18), Common.toDouble(r(19)), Common.toDouble(r(20)),
  ...
  def getNetworkDirection( lineMap: Map[String, Array[String]] ) : String = {
    ...
    if ( lineMap.contains("variablesArr") ) {
      //If already collected before, return the value in memory
      return Common.safeGet( lineMap("variablesArr"),1 )
    }
  ...
  def getServiceUsageType( lineMap: Map[String, Array[String]] ) : String = {
    ...
    if ( lineMap.contains("variablesArr") ) {
      //If already collected before, return the value in memory
      return Common.safeGet( lineMap("variablesArr"),0 )
    }
  ...
  */
  ...
  /**
   * Get subscriber Location from charging context specific
   */
  def getCCSSubsLocation( lineMap: Map[String, Array[String]] ) : String = {
    return this.getChargingContextSpecific(lineMap, "16778217")
  }
  ...
  def getMCCMNC( content: Map[String, Array[String]] ) : String = {
    val serviceUsageType = this.getServiceUsageType(content)
    
     if ( serviceUsageType == "DATA" )  return this.getChargingContextSpecific(content, "16778249") //16778232
     else if ( serviceUsageType == "VOICE" ) return this.getChargingContextSpecific(content, "16778249")
       ...
       try return Common.swapChar( substring(getChargingContextSpecific(content, "16777616"),0,6).replace("F", ""), "2,1,3,5,4" )
         ...
         case e: Exception => return this.getChargingContextSpecific(content, "16778217")
       }
     else return ""     
  }
  ...
  def getLAC( content: Map[String, Array[String]] ) : String = {
     ...
     if ( serviceUsageType == "DATA" && this.getRATType(content) == "6" )  return Common.hexToInt( this.getChargingContextSpecific(content, "16778333") )
     else if ( serviceUsageType == "DATA" )  return Common.hexToInt( this.getChargingContextSpecific(content, "16778250") )
     else if ( serviceUsageType == "VOICE" ) return Common.hexToInt( this.getChargingContextSpecific(content, "16778250") ) 
     else if ( serviceUsageType == "SMS" )   return Common.hexToInt( substring(getChargingContextSpecific(content, "16777616"), 6,10) )
     else return ""     
  }
  ...
  def getCI( content: Map[String, Array[String]] ) : String = {
     ...
     if ( serviceUsageType == "DATA" && this.getRATType(content) == "6" )  return Common.hexToInt( this.getChargingContextSpecific(content, "16778332") )
     else if ( serviceUsageType == "DATA" && this.getRATType(content) == "1" )  return Common.hexToInt( this.getChargingContextSpecific(content, "16778252") )
     else if ( serviceUsageType == "DATA" )  return Common.hexToInt( this.getChargingContextSpecific(content, "16778251") )
     else if ( serviceUsageType == "VOICE" ) return Common.hexToInt( this.getChargingContextSpecific(content, "16778251") ) 
     else if ( serviceUsageType == "SMS" && getChargingContextSpecific(content, "16777616").length() == 18 )   return Common.hexToInt( substring(getChargingContextSpecific(content, "16777616"), 10,18) )
     else if ( serviceUsageType == "SMS" )   return Common.hexToInt( substring(getChargingContextSpecific(content, "16777616"), 10,14) )
     else return ""     
  }
   ...
   * @return
   */
  def getCGI( lineMap: Map[String, Array[String]] ) : String = {
    
     if ( this.getServiceUsageType(lineMap) == "VOICE" ) {
       val lac = this.getChargingContextSpecific(lineMap, "16778250")
       val ci = this.getChargingContextSpecific(lineMap, "16778251")
       val mccmnc = this.getChargingContextSpecific(lineMap, "16778249")
       return this.substring(mccmnc, 1, 2)+this.substring(mccmnc, 0, 1)+"F"+this.substring(mccmnc, 2, 3)+this.substring(mccmnc, 4, 5)+this.substring(mccmnc, 3, 4)+lac+ci
     }
     else if ( this.getServiceUsageType(lineMap) == "SMS" )   return this.getChargingContextSpecific(lineMap, "16777616")
     else return ""     
  }
  ...
  def getDedicatedAccountValuesRow( lineMap: Map[String, Array[String]] ) : String = {
    ...
    //if more than 1 DA
      ...
      while ( i<daArr.length ) {
        //add delimiter if more than 1 DA
        if (i > 0) daReturn = daReturn.concat("^")
        
        //Normalize DA Change
        var daChange = getAmountFromMonetaryUnit( Common.getTuple(daArr(i), "~", 3) )
        if ( daChange.isEmpty() ) daChange = "0.0"
        
        daReturn = daReturn.concat("DA").concat( Common.getTuple(daArr(i), "~", 0) )
          .concat( "~" ).concat( daChange )
          .concat( "~" ).concat( getAmountFromMonetaryUnit( Common.getTuple(daArr(i), "~", 13) ) ) //DA UNIT CHANGE
          .concat( "~" ).concat( getAmountFromMonetaryUnit( Common.getTuple(daArr(i), "~", 14) ) ) //DA UNIT UOM
  ...
  def getTotalDAFromDedicatedAccountValuesRow( content:String ) : Double = {
    ...
    if ( content.contains("^") ) {
      ...
      //Loop for each DA
      while ( i<daArr.length ) {
        if ( Common.getTuple(daArr(i), "~", 3) == "1" ) //If DA type is money
        total = total + Common.toDouble( Common.getTuple(daArr(i), "~", 1) )
        i=i+1
      }
   ...
   * @returns: 1~DA20~375.00~~1 : transposeID~AccountID~Amount~DAUnitAmount~DAUnitType
   */
  def getAccountRowForTranspose( DedicatedAccountValuesRow:String, AccountValueDeducted:Double ) : String = {
    ...
    if (DedicatedAccountValuesRow.isEmpty() ) {
      //MA Only 
      return "1~MA~"+AccountValueDeductedStr
    } else {
      //With DA
      if ( totalMA == 0 ) {
        //MA is zero 
        return "1~"+this.addTransposeIdForAccountRow( DedicatedAccountValuesRow )
      } else {
        //MA is not zero 
        return "1~MA~"+totalMA+"^0~"+this.addTransposeIdForAccountRow( DedicatedAccountValuesRow )
      }      
    }
   ...
   /**
   * Get AccountRow without Transpose (single account only -- for reprocess)
   * @params: Input sample DedicatedAccountValuesRow: DA20~375.00~~1
   * @params: Input sample AccountValueDeducted: 375.00
   * @returns: 1~DA20~375.00~~1 : transposeID~AccountID~Amount~DAUnitAmount~DAUnitType
   */
  def getAccountRowNoTranspose( DedicatedAccountValuesRow:String, AccountValueDeducted:Double ) : String = {
  ...
  /**
   * Add transpose id for string a^b^c
   * @param accountRowForTranspose
   * @return string 1~a^0~b^0~c
   */
  def addTransposeIdForAccountRow( accountRowForTranspose:String ) : String = {
      return accountRowForTranspose.replace("^", "^0~")
  }
  ...
  def getDedicatedAccountValuesRowPostpaid( lineMap: Map[String, Array[String]] ) : String = {
    ...
    //if more than 1 DA
      ...
      while ( i<daArr.length ) {
        ...
        daReturn = daReturn.concat("DA").concat( Common.getTuple(daArr(i), "~", 0) )
          .concat( "~" ).concat( getAmountFromMonetaryUnit( Common.getTuple(daArr(i), "~", 3) ) )
          .concat( "~" ).concat( getAmountFromMonetaryUnit( Common.getTuple(daArr(i), "~", 13) ) )
          .concat( "~" ).concat( getAmountFromMonetaryUnit( Common.getTuple(daArr(i), "~", 14) ) )
  ...
  def getTrafficCase( content: Map[String, Array[String]]) : String = {
    val serviceScenario = this.getServiceScenario(content)
    val roamingPosition = this.getRoamingPosition(content)
    
     if ( serviceScenario == "0" && roamingPosition == "0" ) return "H"
     else if ( serviceScenario == "0" && roamingPosition == "1" ) return "RCAP"
     else if ( serviceScenario == "1" && roamingPosition == "0" ) return "HCF"
     else if ( serviceScenario == "0" && roamingPosition == "0" ) return "RCAPCF"
     else return ""
  }
...
//     return Common.safeGet( lineMap("level3_ccr_cca"),6 )
    //sort by accumulator change and after
    val acm=Common.safeGet( lineMap("level3_ccr_cca"),6 )
    val sorted=acm.split("\\^").map(_.split("~")).sortBy(r => (r(2),r(3))).reverse
    return sorted.map(r => r.mkString("~")).mkString("^")
  }
  ...
  def getCallClassCat( lineMap: Map[String, Array[String]] ) : String = {
     ...
     return  Common.getKeyVal( Common.safeGet(lineMap("level2_ccr"), 10) , "DWSCallClassCategory", "*", "]" )
  }
  ...
  def getTariffCat( lineMap: Map[String, Array[String]] ) : String = {
     //return  Common.getKeyVal( Common.getTuple( Common.getTupleInTuple(content, "|", 13, "[", 0), "#", 10 ) , "DWSCallClassCategory", "*", "]" )
     return  Common.getKeyVal( Common.safeGet(lineMap("level2_ccr"), 10) , "DWSTariffCategory", "*", "]" )
  }
   ...
   */
  def getSpecConsumpSPOfferId( lineMap: Map[String, Array[String]] ) : String = {
    try {
  ...
  def cs5RecordsIsNotGarbageOrHasVolume( lineMap: Map[String, Array[String]] ) : Boolean = {
    
    try {
        val chargingContext = CS5Select.getChargingContextId(lineMap)
        if ( !chargingContext.contains("@3gpp.org") ) return true
        
        val usedOffers = CS5Select.getUsedOfferId(lineMap)
        if ( !usedOffers.isEmpty() ) return true
        
        val volume = CS5Select.getUsageVolume(lineMap)
        ...
        //create match using regex
        val patt = ".~0~.~.~.*.~0~.~.~.*.~0~.~.~.".r
        val ratedUnitsStatus = patt.findFirstIn(ratedUnits) //if record valid then empty, if record garbage then notempty

        return !(chargingContext.contains("@3gpp.org") && usedOffers.isEmpty() && volume==0 && (ratedUnits.isEmpty() || !ratedUnitsStatus.isEmpty) )
    }
    catch {
      case e: Exception => return true
    }
  }
  def cs5RecordsIsNotGarbageNotRegex( lineMap: Map[String, Array[String]] ) : Boolean = {
    ...
    try {
        ...
        //create match by tuple
        val zeroRated = Common.getTupleInTuple(ratedUnits, "*", 0, "~", 1)=="0" && Common.getTupleInTuple(ratedUnits, "*", 1, "~", 1)=="0" && Common.getTupleInTuple(ratedUnits, "*", 2, "~", 1)=="0"

        return !(chargingContext.contains("@3gpp.org") && usedOffers.isEmpty() && (ratedUnits.isEmpty() || zeroRated) )
    }
    catch {
      case e: Exception => return true
    }
  ...
  def getPostVasServiceId ( lineMap: Map[String, Array[String]] ) : String = {
    ...
    if ( vasSvcId.length() >= 13 || vasSvcId.length() <= 14 ) return vasSvcId
    else return ""
  }
  ...
  /**
   * Added for IPCN
   * Normalized CCR_TRIGGER_TIME to +0700 timezone
   */
  def getNormalizedCCRTriggerTime( lineMap: Map[String, Array[String]] ) : String = {    
     
    val ccrTriggerTimeWithTZ = Common.safeGet( lineMap("level2_ccr"), 3 )
    val ccrTriggerTime = ccrTriggerTimeWithTZ.substring(0, 14)
    val getTZ = ccrTriggerTimeWithTZ.substring(15, 17)
    val setTZ ="07"
    
    try {
      val differenceTZ= ((setTZ).toInt - (getTZ).toInt)
      val inputDateFormat = new SimpleDateFormat("yyyyMMddHHmmss")
      val parseDate = inputDateFormat.parse(ccrTriggerTime)
      val dateAfterNormalization= DateUtils.addHours(parseDate, differenceTZ)
  ...
  def getSSPTransactionId( lineMap: Map[String, Array[String]] ) : String = {
    return Common.getTupleInTuple( Common.safeGet( lineMap("level1"), 6 ), ";", 2, "_", 0)
  }
